...
import webpagegenerator2
import webpagegenerator3
...
def WinOpen(self):
    ...
    self.btn_Submit = tk.Button(self.master, width=25, height=2, text = 'Update text & Create webpage!',command=lambda: webpagegenerator2.Update(self))
